...
from app.services import metadata_service, stats_service, tdm_service
...
def _seed_minimal_data() -> None:
    ...
    try:
        has_existing_trips = (
            db.execute(text("SELECT COUNT(*) FROM trips")).scalar_one() > 0
        )
        if has_existing_trips:
            db.commit()
        else:
            db.execute(
                text(
            ...
            db.execute(
                text(
                    ...
                    INSERT INTO road_speed_bins (
                      ...
                      ('seed_rs_1', '2015-01-03 08:00:00', '2015-01-03 08:05:00', 32, 32, 2),
                      ('seed_rs_2', '2015-01-03 08:05:00', '2015-01-03 08:10:00', 46, 46, 2)
            ...
            db.execute(
                text(
                    ...
                    INSERT INTO ingest_runs (
                      run_type, source_file, started_at, finished_at, status, row_count, meta
                    ) VALUES (
                      'pipeline_refresh',
                      'seed',
